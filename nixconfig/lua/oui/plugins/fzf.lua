return {
	...
	keys = {
		...
		{ "<leader>fg", "<cmd>FzfLua lgrep_native<cr>", desc = "Grep directory" },
		...
		-- misc:
		{ "<leader>S", "<cmd>lua require'fzf-lua'.spell_suggest({ winopts = {relative='cursor',row=1.01,col=0, height=0.2, width=0.2}})<cr>",
